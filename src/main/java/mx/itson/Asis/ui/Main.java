    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            lblResultado.setText(primerApellido2.concat(segundoApellido2)
                    ...
                    .concat(genero2).concat(entidadFederativa2).concat(consonantePrimera).concat(consonanteSegunda).concat(consonanteInterna).concat(fechaNacimiento).toUpperCase());
        } catch (Exception e) {
